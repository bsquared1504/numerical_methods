...
public abstract class RootFinder {
   ...
   */
  public void checkInterval(float x1, float x2) throws InvalidIntervalException{
   ...
   */
  public class InvalidIntervalException extends java.lang.Exception {}

  /**
   * Iteration count exceeded exception.
   */
  public class IterationCountExceededException extends java.lang.Exception {}

  /**
   * Position unchanged exception.
   */
  public class PositionUnchangedException extends java.lang.Exception {}
}