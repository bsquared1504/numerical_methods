...
public class IEEE754 implements IEEE754Constants {
  ...
  public IEEE754(double value) {
    // Convert the value to a character array of '0' and '1'.
    char bits[] = toCharBitArray(Double.doubleToLongBits(value), 64);           doubleValue = value;
    isDouble    = true;
    decompose(bits,
   ...
   */
  public IEEE754(int sign, int biasedExponent, FloatFraction fraction) throws Exception{
    // Check the sign.
    if ((sign != 0) && (sign != 1)) {
  ...
  */
  ...
  public static void validateFloatBiasedExponent(int biased) throws Exception {
    if ((biased < 0) ||
      ...
      throw new Exception("The biased exponent value should be " +                                 "0 through " + FLOAT_EXPONENT_RESERVED +                                 ".");
    }
  }
  ...
  public static void validateFloatUnbiasedExponent(int unbiased)
    ...
    if ((unbiased < -FLOAT_EXPONENT_BIAS + 1) ||
      ...
      throw new Exception("The unbiased exponent value should be " +                                 -(FLOAT_EXPONENT_BIAS - 1) + " through " +                                 FLOAT_EXPONENT_BIAS + ".");
    }
  }
  ...
  throws Exception     {
    if ((biased < 0) ||
      ...
      throw new Exception("The biased exponent value should be " +                                 "0 through " +
